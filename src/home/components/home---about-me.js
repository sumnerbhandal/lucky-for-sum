    ...
    return (
        <div className="aboutMe">
            <div className="column">
                ...
                <p>Previously working to keep students safe online and offline at Education Technology company Impero Software. More recently helping to scale a leading e-commerce retailer and build better processes at <a href="https://next.co.uk/" rel="noopener noreferrer" target="_blank">Next</a></p>
